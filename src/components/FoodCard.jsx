...
export default function FoodCard({ id, img, name, price, desc, rating,handleToast }) {
        ...
        <div className="w-[240px] h-[325px] p-5 bg-white ">
            ...
            <div className="flex flex-1 justify-between items-center gap-20">
              ...
              handleToast(name);
                 ...
                 className=' px-1 py-1  bg-yellow-500 text-white hover:bg-black rounded-lg font-medium '>AddToCart</button>
            </div>
        </div>
    )
}